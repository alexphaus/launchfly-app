...
export default function Hero({ 
  ...
  limitedSlots,
  couponCode,
  // NEW: Specific title for the PDF visual
  pdfTitle
}) {
  ...
  // Use the specific PDF title if provided, otherwise fallback to a shortened main title or generic text
  const displayPdfTitle = pdfTitle || (title.length > 25 ? 'Expert Guide' : title);
  ...
  return (
    ...
    >
      ...
      {/* Polished Background Pattern (Subtle Grid) */}
              ...
              <div className="flex justify-center mb-8 -mt-16">
                <div className="relative w-48 h-64 bg-slate-50 rounded-lg shadow-[0_20px_50px_-12px_rgba(0,0,0,0.25)] flex flex-col items-center p-6 text-center border border-slate-200 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                  ...
                  <div className="w-full h-full border-2 border-dashed border-slate-200 rounded flex flex-col items-center justify-center bg-white p-4">
                    ...
                    <h3 className="text-xs font-bold text-slate-900 uppercase tracking-widest leading-relaxed line-clamp-3">
                      {displayPdfTitle}
                    </h3>

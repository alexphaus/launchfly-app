    ...
    if (!expanded) {
        return (
            <div className="mb-4">
                ...
                >
                    <div className={`relative overflow-hidden rounded-2xl border shadow-sm transition-all hover:shadow-md ${
                        hasLeaks 
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-end sm:items-center justify-center">
            <div className="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-md max-h-[92vh] overflow-y-auto animate-slide-up">
                {/* Header */}
                <div className={`sticky top-0 z-10 p-5 pb-4 rounded-t-3xl sm:rounded-t-2xl ${
                    hasLeaks 

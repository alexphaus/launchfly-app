        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl max-w-sm w-full p-6">
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                    <button
                        onClick={() => window.open(`https://wa.me/639627459049?text=Hi! I want to top up ${currency}500 for blast credits. Business: ${businessName}`, '_blank')}
                    ...
                    >
                        <p className="font-bold text-lg">{currency}500</p>
                        <p className="text-xs text-slate-500">100 blasts</p>
                    </button>
                    <button
                        onClick={() => window.open(`https://wa.me/639627459049?text=Hi! I want to top up ${currency}1,000 for blast credits. Business: ${businessName}`, '_blank')}
                    ...
                    >
                        ...
                        <p className="font-bold text-lg text-blue-600">{currency}1,000</p>
                        <p className="text-xs text-slate-500">200 blasts</p>
                    </button>
                    <button
                        onClick={() => window.open(`https://wa.me/639627459049?text=Hi! I want to top up ${currency}2,500 for blast credits. Business: ${businessName}`, '_blank')}
                        className="py-3 px-2 bg-slate-50 hover:bg-blue-50 border-2 border-slate-200 hover:border-blue-400 rounded-xl text-center transition-colors"
                    >
                        <p className="font-bold text-lg">{currency}2,500</p>
